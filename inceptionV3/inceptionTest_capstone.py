...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='D:\\python_D\\fashion_data\outer_capstone',                                             # 여기1
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='D:\\python_D\\inception_file\\capstone_output_graph.pb',                            # 여기2
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='D:\\python_D\\inception_file\\capstone_output_labels.txt',                          # 여기3
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='D:\\python_D\\inception_file\\capstone_retrain_logs',                               # 여기4
      help='Where to save summary logs for TensorBoard.'
  )
  parser.add_argument(
      '--how_many_training_steps',
      type=int,
      default=1000,                                                               # 원래 1000이였음
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='D:\\python_D\\inception_file\\capstone_bottleneck',                               # 여기6 (보틀넥이미지 공유 가능)
