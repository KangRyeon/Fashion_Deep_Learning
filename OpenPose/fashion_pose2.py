# fashion_pose2.py : 한개 파일에 대해 상의, 하의, 전체에 대해 저장할 수 있음. 해당하는 곳에 imwrite 해야 함.
# 저장할 파일명에 대해 가장 위의 cut_filename에 설정해 주어야 함.
import cv2
from PIL import Image

# 잘라서 저장될 파일명
cut_filename = "cut_test.jpg"
...
# filepath 정해주기
filepath = "D:\\python_D\\fashion_project\\fashion_data\\full_body1.jpg"
...
try:
    ...
    cv2.imwrite('D:\\python_D\\fashion_project\\fashion_data\\cutting_image\\'+cut_filename,cut3)
    print("상의 저장")
